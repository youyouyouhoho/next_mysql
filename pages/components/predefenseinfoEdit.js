...
const PredefenseEdit = () => {
  ...
  const onSave = async () => {
    try {
      ...
      for (const data of dataSource) {
        const requestData = {
          PDGroupID: data.PDGroupID,
          PDMem1Name: data.PDMem1Name,
          PDMem2Name: data.PDMem2Name,
          PDMem3Name: data.PDMem3Name,
        };
  
        const response = await fetch(`/api/updatePredefenseInfo`, {
          method: 'POST',
          headers: {
  ...
  const columns = [
    ...
    {
      title: '预答辩委员1',
      dataIndex: 'PDMem1Name',
      width: '15%',
      editable: true,
    },
    {
      title: '预答辩委员2',
      dataIndex: 'PDMem2Name',
      width: '15%',
      editable: true,
    },
    {
      title: '预答辩委员3',
      dataIndex: 'PDMem3Name',
      width: '15%',
      editable: true,
    },
    {
